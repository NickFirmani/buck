...
>>>>>>> parent of 01ae6e7c43... Revert "[buck][PR] Make kotlin_home buck config support specifying source path."
...
// =======
    javaOptionsForTests.get().addParseTimeDeps(targetGraphOnlyDepsBuilder, buildTarget.getTargetConfiguration());
